    ...
    def valid_moves(self, my_color, game_rep):
        ...
        if self.row < 7:
            ...
            if columns_list.index(self.column) < 7:
                my_moves.append(("N",
                                 ...
                                 columns_list[columns_list.index(self.column) + 1] + str(self.row + 2)))
        ...
        if columns_list.index(self.column) < 6:
            ...
            if self.row < 8:
                my_moves.append(("N",
                                 self.board,
                                 self.column + str(self.row),
                                 columns_list[columns_list.index(self.column) + 2] + str(self.row + 1)))
        ...
        for move in my_moves:
            ...
            if game_rep[destination[1]][str(dest_board)][destination[0]] == "" \
                    and game_rep[destination[1]][str(self.board)][destination[0]] == "":
